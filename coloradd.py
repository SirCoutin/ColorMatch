...
def add_color_to_michel(image_path, name):
  ...
  michel_colors.append((name, most_common_match))
...
color_name = input("Enter the name of the respective Michel color")

add_color_to_michel(image_path, color_name.lower())
